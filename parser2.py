...
VARIABLE: "x" | "y" | "z" | "A" | "B" | "C" | "D" | "a" | "b" | "c" | "d" | "f" | "g" | "i" | "n" | "e" | "pi" | "m" | "h" | "p" | "s" | "u" | "k" | "v" | "w" | "r" | "t" | "l"
...
def take_input(equation, funclist=None):
  ...
  def fxchange(tree_node):
    ...
    if funclist is not None:
        tmp3 = funclist
    return TreeNode("f_"+tree_node.name if tree_node.name in tmp3+["gt", "lt", "eqtri", "linesegment", "midpoint", "mag", "point1", "point2", "point3", "line1", "line2", "line3", "log10", "arcsin", "arccos", "arctan", "list", "cosec", "sec", "cot", "equiv", "or", "not", "and", "circumcenter", "transpose", "eq", "sub", "neg", "inv", "add", "sin", "cos", "tan", "mul", "integrate", "dif", "pow", "div", "log", "abs"]\
